...
kubectl apply -f /home/djohn/kuber-deployment/istio-playgroud/sample-bookinfo.yaml
kubectl get svc
kubectl apply -f /home/djohn/kuber-deployment/istio-playgroud/bookinfo-gateway.yaml
