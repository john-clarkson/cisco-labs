...
!Running configuration last done at: Mon Jan 13 14:56:17 2020
!Time: Mon Jan 13 15:02:52 2020
...
dcbspine1(config)# end
dcbspine1# sh ip int b

IP Interface Status for VRF "default"(1)
Interface            IP Address      Interface Status
Lo0                  100.64.2.1      protocol-up/link-up/admin-up       
Lo1                  100.64.2.11     protocol-up/link-up/admin-up       
Lo100                100.64.100.100  protocol-up/link-up/admin-up       
Eth1/1               169.254.2.1     protocol-up/link-up/admin-up       
Eth1/6               169.254.93.6    protocol-up/link-up/admin-up       
dcbspine1# sh ip os neighbors 
 OSPF Process ID 1 VRF default
 Total number of neighbors: 2
 Neighbor ID     Pri State            Up Time  Address         Interface
 100.64.2.2        1 FULL/DR          09:16:01 169.254.2.2     Eth1/1 
 100.64.93.93      1 FULL/DR          01:32:39 169.254.93.5    Eth1/6 
dcbspine1# show ip ospf interface b
 OSPF Process ID 1 VRF default
 Total number of interface: 5
 Interface               ID     Area            Cost   State    Neighbors Status
 Eth1/1                  2      0.0.0.0         40     BDR      1         up  
 Eth1/6                  4      0.0.0.0         40     BDR      1         up  
 Lo0                     1      0.0.0.0         1      LOOPBACK 0         up  
 Lo1                     3      0.0.0.0         1      LOOPBACK 0         up  
 Lo100                   5      0.0.0.0         1      LOOPBACK 0         up  

dcbspine1# show bgp l2vpn evpn
BGP routing table information for VRF default, address family L2VPN EVPN
BGP table version is 47, Local Router ID is 100.64.2.1
...
dcbspine1# show nve peer
Interface Peer-IP                                 State LearnType Uptime   Route
r-Mac       
--------- --------------------------------------  ----- --------- -------- -----
------------
nve1      100.64.2.2                              Up    CP        00:12:19 5000.
0005.0007   
